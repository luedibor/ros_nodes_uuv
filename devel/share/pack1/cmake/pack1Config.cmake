...
if("TRUE" STREQUAL "TRUE")
  set(pack1_SOURCE_PREFIX /root/sw1/src/pack1)
  set(pack1_DEVEL_PREFIX /root/sw1/devel)
  set(pack1_INSTALL_PREFIX "")
  set(pack1_PREFIX ${pack1_DEVEL_PREFIX})
else()
  set(pack1_SOURCE_PREFIX "")
  set(pack1_DEVEL_PREFIX "")
  set(pack1_INSTALL_PREFIX /root/sw1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pack1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/sw1/src/pack1/${idir}'.  ${_report}")
    endif()
